        ...
        <div className="container">
          ...
          <div className="content-section">
            ...
            <p className="intro">
              ...
              Information Technology at Medhavi Skills University in Sikkim. Love to
              explore new things and upgrade myself in time.
            </p>
            
            <div className="social_Applications">
              <ul className="apps">
                <li>
                  <a href="https://github.com/Sujal-Thapa1" target="_blank" rel="noopener noreferrer">
                ...
                <li>
                  <a href="https://t.ly/GlHbn" target="_blank" rel="noopener noreferrer">
